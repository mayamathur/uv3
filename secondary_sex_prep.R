...
#  ease of calling fn
f2 = l %>% group_by(stim.name, w1_sex) %>%
...
write.csv(f, "face_aggregated_detailed_by_subject_sex.csv", row.names = FALSE)
write.csv(f2, "face_aggregated_simple_by_subject_sex.csv", row.names = FALSE)
